...
function build() {
  ...
  for (const name of ["mention-core", "inbox-core", "approval-core", "approval-commands", "memory-hint-core", "memory-command", "codex-delivery-core", "codex-delivery", "local-store", "hook-handler", "install-core", "onboarding-steps", "native-commands"]) {
