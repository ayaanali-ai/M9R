...
function build() {
  ...
  for (const name of ["mention-core", "inbox-core", "approval-core", "risk-core", "approval-commands", "feed-core", "feed-writer", "memory-hint-core", "memory-command", "codex-delivery-core", "codex-liveness", "codex-delivery", "codex-watch-core", "codex-watch", "local-store", "hook-handler", "hook-run", "hook-server", "install-core", "onboarding-steps", "native-commands"]) {
